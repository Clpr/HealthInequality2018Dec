...
PROC SQL;
	CREATE TABLE WORK.CHARLS_COMM AS SELECT DISTINCT
		...
		COUNT(AGE) AS SAMPLESIZE,  /*NUMBER OF SAMPLES IN THIS GROUP*/
		/***** demography ******/
...
/*interval. scale adjustment*/
DATA WORK.CHARLS_CITY;
	SET WORK.CHARLS_CITY;
	/*adjust AVGINDIINCOME_TOTAL to 10 thousand yuan*/
	AVGINDIINCOME_TOTAL = AVGINDIINCOME_TOTAL / 10000;
RUN;
...
PROC EXPORT DATA = WORK.CHARLS_CITY OUTFILE = "E:\CHARLS_DB\harmonized 2018\CHARLS_CITY.xlsx" REPLACE;RUN;
